 ...
 * @dev Copied from the audited zyfai-executor-module/src/registry/TargetRegistry.sol.
 *      Deployed as a separate instance for the borrow agent's flashloan module.
 *      Security Features:
